---
title: Math Nodes
description: Per-pixel arithmetic between two maps, hard thresholding, and tonal quantization into flat bands.
---
...
Quantizes the input to a fixed number of steps, replacing continuous gradation with flat bands. Used for stylised looks and for stepped-height effects like terraces or stacked plating.
