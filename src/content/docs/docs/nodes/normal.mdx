...
- Occlusion (grayscale): classic ambient occlusion, dark where the neighbourhood stands above the point.
...
| Scale | Float | 4.0 | 1.0 to 64.0 | How far apart the samples that measure direction sit, in pixels. Raise it on smooth inputs; too small a spacing quantises the field into a handful of angles and facets it. |
