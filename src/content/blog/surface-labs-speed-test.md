...
<figure>
  <video src="/video/sl_blur.webm" controls muted loop playsinline preload="metadata" style="width:100%"></video>
...
<figure>
  <video src="/video/sd_blur.webm" controls muted loop playsinline preload="metadata" style="width:100%"></video>
...
<figure>
  <video src="/video/sl_sampler.webm" controls muted loop playsinline preload="metadata" style="width:100%"></video>
  <figcaption>Surface Labs: node settings, then seed cycling. The Tile Sampler sits at ~1 ms per roll.</figcaption>
</figure>

<figure>
  <video src="/video/sd_sampler.webm" controls muted loop playsinline preload="metadata" style="width:100%"></video>
