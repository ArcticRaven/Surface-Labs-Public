...
by default — turn it on when a material is meant to be a light source rather
than a surface.
...
are sharper, and colored textures stop darkening as they recede — the mip chain
is filtered in linear light now.
...
of the image. Big blurs and grows are cleaner across the board — no dropout
